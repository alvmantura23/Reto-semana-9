...
c)Si no se cumplen ninguna de las condiciones anteriores debe mostrarse por pantalla
...
Ejm:
Entrada:    Ingrese el diámetro de una rueda = 1.1
            Ingrese el grosor de la rueda = 0.24
Salida:     La rueda es para un vehículo mediano.
...
•Si el vehículo es un "coche", el precio ha de ser 0.20.
